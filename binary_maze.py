...
remove_idx = {
    ...
    31,  # [[6.0, -8.0], [6.0, -6.0]]
    33,  # [[8.0, 4.0], [8.0, 6.0]]
    38,  # [[10.0, -2.0], [10.0, 0.0]]
    42,  # [[-8.0, 10.0], [-6.0, 10.0]]
    47,  # [[-10.0, 6.0], [-8.0, 6.0]]
    53,  # [[8.0, 2.0], [10.0, 2.0]]
    60,  # [[-4.0, -4.0], [-2.0, -4.0]]
    65,  # [[-2.0, -6.0], [0.0, -6.0]]
...
walls2 = np.array([w for k, w in enumerate(walls) if k not in remove_idx])


obstacles1=prep(MultiLineString([[(w[0][0], w[0][1]), (w[1][0], w[1][1])] for w in walls1]))
obstacles2=prep(MultiLineString([[(w[0][0], w[0][1]), (w[1][0], w[1][1])] for w in walls2]))